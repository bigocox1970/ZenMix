...
function CookieConsent() {
  return `
    <div id="cookie-consent" class="fixed bottom-0 left-0 right-0 bg-dark border-t border-gray-800 p-4 z-50 hidden">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between">
          <div class="mb-4 md:mb-0 md:mr-8">
            <p class="text-gray-300 text-sm md:text-base">
              ...
              <a href="/cookies.html" class="text-primary hover:underline ml-1">
                Learn more
              </a>
            </p>
          </div>
          <div class="flex space-x-4">
            ...
            <button 
              id="accept-cookies"
              class="px-4 py-2 gradient-button text-sm rounded-lg"
            >
              Accept All Cookies
            </button>
          </div>
